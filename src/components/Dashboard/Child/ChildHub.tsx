                ...
                <>
                  ...
                  >
                    <div className="flex flex-col gap-1">
                       <button onClick={() => window.location.href = '/dashboard'} className={`w-full p-3.5 hover:${theme.bgLight} rounded-2xl flex items-center gap-3.5 ${theme.text} transition-colors group text-left`}><div className={`p-2 ${theme.bgLight} rounded-xl group-hover:${theme.primaryBg} group-hover:text-white transition-colors`}><Home size={17}/></div><span className="font-black uppercase tracking-widest text-[10px]">Mis Bebés</span></button>
